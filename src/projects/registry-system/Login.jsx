        ...
        <div className="h-dvh w-dvw bg-gray-100 md:ml-4">
          ...
          >
            ...
            <div className="flex justify-evenly w-full items-center h-10">
              <div>
                <input type="checkbox" name="remember" id="check" className="accent-teal-700 mr-2 size-[clamp(0.6rem,5vw,1rem)]" />
                <label htmlFor="check" className=" text-teal-700 text-[clamp(0.6rem,5vw,1rem)]">Remember me</label>
              </div>
              <div>
                <a className="text-teal-700 underline hover:decoration-wavy text-[clamp(0.6rem,5vw,1rem)]">Forgot password?</a>
              </div>
            </div>
            <button
              ...
              onClick={() => navigate("/projects/success")}
            >
              Lonin
            </button>
          </Form>
